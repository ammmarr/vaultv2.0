...
const aboutUsData = [
	{
		...
		content: (
			...
			>
				We are the leading distributor for high-end automotive brands in Egypt.
				Established in 2019 in Dubai, UAE, as an extension of our UAE-based
				sister company "Tazweed," we have grown to supply the Egyptian market
				with the best luxury automotive products. We take pride in representing
				prestigious Russian manufacturers like STP and ACV, among many other
				distinguished luxury names. Our product selection has earned the trust
				of elite car manufacturers such as Audi, Bentley, Bugatti, Lamborghini,
				Porsche, Volkswagen, Jaguar Land Rover, Ferrari, Maserati, BMW, and
				Mercedes-Benz. At Vault, we've built a reputation for supplying
				exclusive, sought-after, and premium service products that enjoy global
				acclaim. Specializing in luxury sports cars and high-performance
				vehicles, we've cemented our reputation as a reliable provider in the
				Middle East, particularly in the Gulf. Our success is driven by our
				dedication to understanding and meeting our customers' desires,
